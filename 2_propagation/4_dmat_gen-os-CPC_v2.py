...
nbf=64               # ??? might need to think about linear dependencies. 
nmo=64
...
while line < len(C_lines):
	...
	while i < len(element):
		...
		i=i+1
	line=line+1
Cmo=np.array(Cmo_list).reshape(nmo,nbf)
#print(Cmo)
